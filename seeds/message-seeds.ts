...
const messageData = [
  {
    ...
    answer_text:
      '\nTeachBot: Ok, great question. First you need to add a variable, let say its called JSarray. Then you need to define it, like so. var i =0; Next, you need to define the array itself like so. var JSarray = []; Finally, when you want to add to an array, you need to add the JSarray.push. For example. JSarray.push(',
  },
  {
    user_id: 1,
    question_id: 1,
